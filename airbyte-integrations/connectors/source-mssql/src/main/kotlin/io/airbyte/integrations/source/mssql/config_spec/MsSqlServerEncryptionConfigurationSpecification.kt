...
@JsonSubTypes(
    JsonSubTypes.Type(value = MsSqlServerEncryptionDisabledConfigurationSpecification::class, name = "unencrypted"),
    JsonSubTypes.Type(
        value = MsSqlServerEncryptionRequiredTrustServerCertificateConfigurationSpecification::class,
...
data object MsSqlServerEncryptionDisabledConfigurationSpecification : MsSqlServerEncryptionConfigurationSpecification
...
class MicronautPropertiesFriendlyMsSqlServerEncryption {
    ...
    fun asEncryption(): MsSqlServerEncryptionConfigurationSpecification =
        when (mode) {
            ...
            "required" -> MsSqlServerEncryptionRequiredTrustServerCertificateConfigurationSpecification
