...
class MysqlSourceConfigurationSpecificationTestTest {
    @Inject
    lateinit var supplier: ConfigurationSpecificationSupplier<MsSqlServerSourceConfigurationSpecification>
    ...
    fun testJson() {
        ...
        Assertions.assertTrue(encryption is MsSqlServerEncryptionDisabledConfigurationSpecification, encryption!!::class.toString())
